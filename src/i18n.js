...
const STRINGS = {
  en: {
    ...
    practice_title: 'Practice Drills',
    practice_sub: 'Short timed exercises that sharpen real coding skills.',
    best: 'Best',
    score: 'Score',
    time: 'Time',
    begin: 'Start',
  ...
  ky: {
    ...
    practice_sub: 'Код жазуу көндүмүн курчутуучу кыска көнүгүүлөр.',
    best: 'Рекорд',
    score: 'Упай',
    time: 'Убакыт',
    begin: 'Баштоо',
