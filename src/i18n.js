...
const STRINGS = {
  en: {
    ...
    badges: 'Badges',
    lab_title: 'Code Lab',
    lab_sub: 'Your own workspace. Write anything and press Run.',
    practice_title: 'Activities',
    practice_sub: 'Short, sharp exercises. Pick one and see how far you get.',
    best: 'Best',
    score: 'Score',
    time: 'Time',
    begin: 'Start',
  ...
  ky: {
    ...
    nav_home: 'Башкы',
    nav_journey: 'Жол',
    nav_practice: 'Көнүгүүлөр',
    nav_lab: 'Код лабораториясы',
    nav_book: 'C++ китеби',
    nav_notes: 'Дептер',
    ...
    badges: 'Белгилер',
    lab_title: 'Код лабораториясы',
    lab_sub: 'Өз жумуш ордуң. Каалаганыңды жазып, Иштет баскычын бас.',
    practice_title: 'Көнүгүүлөр',
    practice_sub: 'Кыска көнүгүүлөр. Бирин тандап, канчалык алыс кетериңди көр.',
    best: 'Рекорд',
    score: 'Упай',
    time: 'Убакыт',
    begin: 'Баштоо',
