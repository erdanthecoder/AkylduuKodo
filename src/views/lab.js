  ...
  return h(
    ...
    h('div', { class: 'card' },
      h('div', { class: 'bench-split' },
        h('div', { class: 'bench-code' }, h('span', { class: 'bench-label' }, 'Your code'), editor.el),
        h('div', { class: 'bench-out' }, cons.el),
      ),
      h('div', { class: 'row gap tools' },
        h('button', { class: 'btn btn-run', onclick: run }, icon('play', { size: 16 }), ui('run')),
        h('button', { class: 'btn btn-ghost', onclick: () => { editor.value = ''; cons.clear(); } }, icon('reset', { size: 16 }), ui('reset_code')),
      ),
